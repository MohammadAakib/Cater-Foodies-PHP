                    ...
                    <div class="tables">
                        ...
                        <div class="bs-example widget-shadow" data-example-id="bordered-table"> 
                            ...
                            while ($row = mysqli_fetch_array($q)) {
                                ...
                                echo "<td> <a Onclick='return confirmdelete()'; href='delete-package-master.php?deleteid={$row['package_master_id']}'>Delete</a></td>";
                                echo "<td> <a href='edit-package-master.php?editid={$row['package_master_id']}'>Edit</a></td>";
                                echo "<tr>";
                            }
                            echo "</tbody>";
                            echo "</table>";
