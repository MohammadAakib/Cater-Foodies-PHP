        ...
        <div class="main-content">
            ...
            <div id="page-wrapper">
                <div class="main-page">
                    <div class="forms">
                        <div class="row">
                            <h3 class="title1">Order Master :</h3>
                            <div class="form-three widget-shadow">
                                <form class="form-horizontal" method="post">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-8">
                                            <input type="date" class="form-control1" name="order_date" required="" placeholder="Enter Date">
                                        </div>
                                    </div>
                                     <div class="form-group">
                                         <label for="order_date" class="col-sm-2 control-label">Customer Id</label>
                                       <?php
                            ...
                            if (isset($_POST['submit'])) {
                                ...
                                $q = mysqli_query($conn, "insert into tbl_order_master(order_date,customer_id,status) values('{$order_date}','{$customer_id}','{$status}')") or die(mysqli_error($conn));
