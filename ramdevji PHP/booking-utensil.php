<?php
    ...
    $query = mysqli_query($conn,"SELECT * FROM `tbl_utensil_master` where utensil_id='{$uid}'") or die(mysqli_error($conn));
...
<body> 
	...
	<div class="about">
		...
		<h3 class="w3ls-title w3ls-title1">Checkout</h3>
                    <form method="post" id="checkout-form" action="booking-process.php" class="shopform">
                        <div class="row">
                            <div class="col-md-6">
                                ...
                                <div class="row">
                                    <input type="hidden" name="utensil_id" value="<?php echo $uid;?>">
                                    ...
                                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                        <label>QTY *</label>
                                        <input type="text" name="qty" id="qty" value=""  class="form-control" placeholder="Enter No Of QTY">
                                    </div>
                                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                        <label>Price *</label>
                                        <input type="text" name="utensil_price" id="utensil_price" value="<?php echo $row_un["utensil_price"];?>"  class="form-control" placeholder="Enter No Of QTY" readonly="">
                                    </div>
                                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
