        ...
        <div class="about">
            <div class="container"> 
               <h3 class="w3ls-title w3ls-title1">Checkout</h3>
                ...
                <form method="post" id="checkout-form" action="checkout-utensil-process.php" class="shopform">
                    <div class="row">
                        <div class="col-md-6">
                            ...
                            <div class="row ">
                                <input class="textcolor" type="hidden" name="total" value="<?php echo $finalsum; ?>">
                                ...
                                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                    <label>Time *</label>
                                    <input type="time" name="time" id="time" value=""  class="form-control" placeholder="Enter No Of Person">
                                </div>
                                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
