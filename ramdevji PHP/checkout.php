                    ...
                    <div class="table-responsive">
                        <table class="table">
                          ...
                          ?>
                            ...
                            <tfoot>
                                <tr>
                                    <td colspan="4"></td><td>Subtotal</td><td>Rs. <?php echo $finalsum;?></td>
                                </tr>
                                 <tr>
                                    <td colspan="4"></td><td>Shipping Charge</td><td>Rs. 200</td>
                                </tr>
                                <tr>
                                    <td colspan="4"></td><td>Grand Total</td><td>Rs. <?php echo $finalsum+200;?></td>
                                </tr>
                            </tfoot>
                        </table>
                    </div>
                        <form method="post" id="checkout-form" action="checkout-process.php" class="shopform">
                            <div class="row">
                                <div class="col-md-6">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                         ...
                                         <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                            ...
                                            <input type="text" name="no_of_person" id="no_of_person" value=""  class="form-control" placeholder="Enter No Of Person">
                                        </div>
